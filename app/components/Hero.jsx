    ...
    <section className="relative z-10 px-6 md:px-16 sm:py-24 sm:max-w-7xl sm:mx-auto py-10 overflow-hidden text-[#FFF212]">
      ...
      <div>
        ...
        >
          ...
          <br /> <br />
          This manual aims to help clinicians use ultrasound not merely as a diagnostic tools, but as an essential guide in managing complex and high-risk pregnancies to improve maternal and fetal outcomes.
          <br /><br />
